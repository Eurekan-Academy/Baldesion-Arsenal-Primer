...
We never use `Aetheric Stabilisers` on our rund, as we have assigned portal locations. Using a stabiliser would cause chaos as the portal locations would likely change and people could loose out on the run. As such **Stabilisers are banned** for the main group and only allowed for the Support group.
